...
# Message under the button with line break after "Note:"
st.markdown(
    """
    <div style="font-size: 14px; color: gray; margin-top: 20px;">
        <p><strong>Note:</strong><br>
        1) The model is not perfect, and the prediction is not guaranteed to give perfect results. 
        <br>2) If an error occurs, please refresh the demo page.
        </p>
    </div>
    """, 
    unsafe_allow_html=True
